...
export const projects: Project[] = [
  ...
  {
    title: 'Databases with Replit Agent',
  ...
  },
  {
    ...
    liveUrl: 'https://x.com/mattppal/status/1867703377888784880',
    badges: ['Web App', 'Tools'],
    category: 'code',
  },
  {
    title: 'remove-bg',
    description: 'Background removal with transformers.js',
    imageUrl: assets.projects['remove-bg'],
    liveUrl: 'https://x.com/mattppal/status/1828829915460075540',
    badges: ['Web App', 'Tools'],
    category: 'code',
  },
];
